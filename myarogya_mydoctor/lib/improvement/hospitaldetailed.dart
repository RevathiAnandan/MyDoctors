                          ...
                          Container(
                            ...
                            child: GridView.count(
                              ...
                              children: List.generate(
                                widget.hospitalvalues.image.length,
                                (index) {
                                  return Image(
                                    image: NetworkImage(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: DataTable(
                                  ...
                                  rows: widget.hospitalvalues.freebeds
                                      .map(
                                        (e) => DataRow(cells: [
                                          DataCell(Container(
                                              width: 130,
                                              child: Text(e.roomType))),
                                          DataCell(Container(
                                              width: 50,
                                              child: Text(e.noOfBeds))),
                            ...
                            Container(
                              ...
                              child: DataTable(
                                  ...
                                  rows: widget.hospitalvalues.conbeds
                                      .map(
                                        (e) => DataRow(cells: [
                                          DataCell(Container(
                                              width: 90,
                            ...
                            Container(
                              ...
                              child: DataTable(
                                  ...
                                  rows: widget.hospitalvalues.covidbeds
                                      .map(
                                        (e) => DataRow(cells: [
                                          DataCell(Container(
                                              width: 90,
                            ...
                            Container(
                              ...
                              child: DataTable(
                                  ...
                                  rows: widget.hospitalvalues.diagnosis
                                      .map(
                                        (e) => DataRow(cells: [
                                          DataCell(Container(
                                              width: 130, child: Text(e.test))),
                                          DataCell(Container(
                                              width: 50,
                                              child: Text(e.charge))),
                                        ]),
                            ...
                            Container(
                              ...
                              child: DataTable(
                                  ...
                                  rows: widget.hospitalvalues.health
                                      .map(
                                        (e) => DataRow(cells: [
                                          DataCell(Container(
                                              width: 130,
                            ...
                            Container(
                              ...
                              child: DataTable(
                                  ...
                                  rows: widget.hospitalvalues.surgery
                                      .map(
                                        (e) => DataRow(cells: [
                                          DataCell(Container(
                                              width: 130,
                                              child: Text(e.surgeryname))),
                                          DataCell(Container(
                                              width: 50,
                                              child: Text(e.suramount))),
                                        ]),
                                      )
                                      .toList()),
                            ),
                            ...
                            Container(
                              ...
                              child: DataTable(
                                  ...
                                  rows: widget.hospitalvalues.doctorslist
                                      .map(
                                        (e) => DataRow(cells: [
                                          DataCell(Container(
                                              width: 150, child: Text(e.name))),
                                          DataCell(Container(
                                              width: 100, child: Text(e.phno))),
                                          DataCell(Container(
                                              width: 100,
                            ...
                            Container(
                              ...
                              child: DataTable(
                                  ...
                                  rows: widget.hospitalvalues.nurseslist
                                      .map(
                                        (e) => DataRow(cells: [
                                          DataCell(Container(
                                              width: 150, child: Text(e.name))),
                            ...
                            Container(
                              ...
                              child: DataTable(
                                  ...
                                  rows: widget.hospitalvalues.staffslist
                                      .map(
                                        (e) => DataRow(cells: [
                                          DataCell(Container(
                                              width: 150, child: Text(e.name))),
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    onTap: () =>Navigator.push(
                                      context,
                                      MaterialPageRoute(builder: (context) => HospitalTerms(widget.hospitalvalues.termsandconditions)),
                                    ),
                                    child: Text(
  ...
  getdatatable(List<OtherBeds> beds) {
    ...
    list.add(new Container(
      ...
      child: DataTable(
          ...
          rows: widget.hospitalvalues.beds
              .map(
                (e) => DataRow(cells: [
