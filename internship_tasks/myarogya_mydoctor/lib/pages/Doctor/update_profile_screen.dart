...
//      _phone.text = widget.mobile;
                          ...
                          Expanded(
                            child: new Column(
                              ...
                              children: [
                                SizedBox(height: 30 ),
                                Container(
                                    child: Text('Hello Doctor !', style: TextStyle(color:Colors.white, fontSize: 26, fontWeight: FontWeight.w500,fontFamily: "Lato"))
                                ),
                                SizedBox(height: 10 ),
                                Container(
                          ...
                          child: new Column(
                            children: <Widget>[
                              new Container(
                                ...
                                child: ListView(
                                  children: <Widget>[
                                    Text("Professional Details",style: new TextStyle(fontWeight: FontWeight.bold,fontFamily: "Lato",color: Colors.blueAccent)),
                                    SizedBox(height: 10,),
                                    ...
                                    SizedBox(height: 5,),
                                    Text("Degree",style: new TextStyle(fontWeight: FontWeight.normal,fontFamily: "Lato")),
                                    SizedBox(height: 5,),
                                    TextFormField(
                                      decoration: InputDecoration(
                                          contentPadding: EdgeInsets.fromLTRB(20.0, 5.0, 20.0, 5.0),
                                          prefixIcon: new Icon(Icons.library_books ,color: new Color(0xffACCCF8)),
                                          enabledBorder: OutlineInputBorder(
                                              borderRadius: BorderRadius.all(Radius.circular(8)),
                                              borderSide: BorderSide(color: Colors.blueAccent)
                                          ),
                                    ...
                                    Container(
                                      ...
                                      child: FlatButton(
                                        ...
                                        onPressed: (){
                                          updatingProfile(_image,_doctorId.text,_hospitalName.text,_specialist.text,_degree.text,_dName.text,_email.text);
                                        },
  ...
  Future<void> updatingProfile(File image, String doctorId, String hospitalName, String specialist, String degree, String dName, String email) async {
    ...
    if (taskSnapshot.error == null) {
      if (widget.userId != null && widget.mobile != null) {
        ...
        ApiService().updateProfile(widget.userId, widget.mobile, ConstantUtils().Doctor, downloadUrl, doctorId, hospitalName, specialist, degree, dName, email);
        Navigator.push(
          context,
          MaterialPageRoute(
