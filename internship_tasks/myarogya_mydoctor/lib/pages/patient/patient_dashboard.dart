              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    child: Text("My Doctors",style: new TextStyle(color:Colors.black,fontSize: 20,fontWeight: FontWeight.bold,fontFamily: "Lato")),
                  ),
                  Container(
                    decoration: BoxDecoration(
...
//                                checkmobile();
                                ...
                                child: Card(
                                  ...
                                  child: Center(
                                      child: Text('Add Doctor',style: TextStyle(color: Colors.white,fontSize: 17,fontWeight: FontWeight.bold),)
//                               IconButton(
...
//                ),
                  ...
                  Container(
                    alignment: Alignment.centerLeft,
                    padding: EdgeInsets.only(left: 25,top: 16,right: 16,bottom: 16),
                    child: Text("My Hospitals",style: new TextStyle(color:Colors.black,fontSize: 20,fontWeight: FontWeight.bold,fontFamily: "Lato")),
                  ),
                  Container(
                    padding: EdgeInsets.only(bottom: 16,left: 16,right: 16,top: 25),
                    height: 120,
                            ...
                            Container(
                              ...
                              child:  GestureDetector(
                                ...
                                child: Card(
                                  ...
                                  elevation: 6,
                                  shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(30)),
                                    child: Center(child: Text('Add Hospitals',style: TextStyle(color: Colors.white,fontSize: 17,fontWeight: FontWeight.bold),))
                                  // child: Center(
                                  //   child: IconButton(
                                  //     icon:Icon(Icons.add,color: Colors.white,
                                  //     ),
